...
class ShoppingCartDetail extends StatelessWidget {
  ...
  ShoppingCartDetail({Key? key, this.state}) : super(key: key);
  final state;
  ...
  Widget _buildDetailNameAndPrice() {
    ...
    List<String> selectedCountryEng = [
      "Mondstadt",
      "Liyue",
      "Inazuma",
      "Sumeru",
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _buildDetailIcon(selectedCountry[state]),
            ],
          ),
        ],
      ),
